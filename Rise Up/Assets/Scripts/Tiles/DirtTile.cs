...
public class DirtTile : TerrainTile {
	...
	#if UNITY_EDITOR
	[MenuItem("Assets/Create/DirtTile",false,1)]
	private static void CreateDirtTile()
	{
		...
		string fName2 = "DirtTile";
		DirtTile myAT = new DirtTile();
	...
	{
		Sprite[] myTextures = Resources.LoadAll<Sprite>("Textures/dirtsheet") ;
		return myTextures;
	}
	#endif
